...
El modo privacidad sólo enmascara datos estructurados de la interfaz y nunca transforma ni censura el PDF original. Si está activo, antes de abrir el visor la UI advierte que el documento puede mostrar información salarial y ofrece cancelar o continuar explícitamente. Continuar no omite MFA, step-up, ownership, autorización previa ni la URL firmada breve, y no genera una copia redactada.
