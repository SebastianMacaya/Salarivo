...
| Robo de sesión | cookies HttpOnly/Secure/SameSite, validación de Origin, primer enrolamiento limitado a una sesión primaria de 15 minutos, rotación/revocación, MFA de sesión y step-up sensible | sesión primaria antigua no inicia MFA, sesión revocada, cookie rotada y acción sin step-up |
