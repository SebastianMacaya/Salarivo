...
| Robo de sesión | cookies HttpOnly/Secure/SameSite, validación de Origin, primer enrolamiento limitado a una sesión primaria de 15 minutos, listado owner-only, revocación individual/masiva con step-up, rotación y MFA de sesión | sesión primaria antigua no inicia MFA, lista no cruza owners, sesión ajena/actual no se revoca, sesión revocada falla y acción sin step-up se rechaza |
