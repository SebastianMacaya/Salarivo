...
- Una cuenta sin MFA completa step-up mediante otra autorización Google con `max_age=0`, ligada a la sesión y al propósito originales. Al completarse rota la sesión. Revocar otras sesiones conserva sólo la actual.
