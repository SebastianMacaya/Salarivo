...
- Elevar garantía, regenerar códigos, reemplazar o desactivar MFA rota el token de la sesión; los cambios de seguridad revocan las otras sesiones. La vista inline del original está disponible durante la sesión exacta que ya verificó MFA; usuarios sin MFA, descargas como attachment, cambios MFA, acciones destructivas y claim de export exigen step-up reciente. Estas acciones vuelven a bloquear y validar esa sesión dentro de su transacción.
