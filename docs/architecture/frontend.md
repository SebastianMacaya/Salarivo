...
El historial conserva datos completos: las series usan un gráfico desplazable dentro de su contenedor, selección de período y tabla exacta desplegable. Resumen e Historial muestran básico comparable, bruto total y neto total con una escala común en el gráfico; las perspectivas económicas usan los importes proyectados disponibles, sin completar valores ausentes. Los importes del mes se muestran en una franja fuera del área desplazable; hover y foco de teclado actualizan esa lectura sin recortarla en los bordes. Al salir, vuelve al mes seleccionado o al último disponible. El modo privacidad también oculta los importes y la forma salarial reconstruible del gráfico. Nombres de empresa, importes y metadata envuelven; el encabezado compacto del recibo tiene el nombre completo disponible en sus datos.
